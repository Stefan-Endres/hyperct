...
The code in this file is heavily modified code (12.01.2023) from the
Pele repository https://github.com/pele-python/pele, released
 under GPLv3 licence by Jacob Stevenson and other listed contributors.

sqlalchemy has been removed as a dependecy. Future versions will attempt
to completely remove dependencies and replace networkx with hyperct objects.
...
class DisconnectivityGraph(object):
    ...
    def _getEnergy(self, node):
        ...
        try:
            ...
            return node.energy  # In this case it is a TransitionState objecte
    ...
    def _getTS(self, min1, min2):
        ...
        #       print(f'min1 = {min1}')
        #       print(f'min2 = {min2}')
        #       print(f'(min1, min2) = {(min1, min2)}')
        #       print(f'self.transition_states = {self.transition_states}')
        try:
    ...
    def label_minima(self, minima_labels, axes=None,
        ...
        Notes
        -----
        if the labelenergy_caches are outside of the figure bounding box you can fix it with
